import type { AuditRepository, AuditEvent, TenantEventLog } from '@terabound/domain';
...
export class AuditService {
   ...
   */
  async logFailure(event: Omit<AuditEvent, 'createdAt'>): Promise<void> {
    await this.logGlobal(event);
  }
